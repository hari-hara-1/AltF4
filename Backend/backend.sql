...
CREATE TABLE user_financial_profile (
    ...
    location_type ENUM('Urban','Rural','Semi-Urban','None'),
    income_type ENUM('Salaried','Gig','Informal','None'),
    age_to_employment_ratio DECIMAL(4,2),
    housing_type ENUM('Owned','Rented','PG','None'),
    ...
    education_level ENUM('12th','Diploma','Graduate','PostGrad','None','PhD'),
